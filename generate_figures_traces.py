...
T = 4000  # Simulation Time [ms] (Overall time might differ as CI can increase this if needed)
...
NEURON_INDEXES: List[int] = [21, 22, 23, 24]
MODELS = zip(
